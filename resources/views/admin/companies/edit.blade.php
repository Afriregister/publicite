            ...
            <div class="pd-20 card-box mb-30">
                ...
                @endif
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select class="custom-select2 form-control" name="user_id">
                                ...
                                @foreach ($users as $user)
                                    @if ($user->id == old('user_id',$company->user_id))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="name" value="{{ old('name',$company->name) }}" type="text" placeholder="{{ __('Name') }}">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">{{ __('TIN') }}</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="tin" value="{{ old('tin',$company->tin) }}" type="text" placeholder="{{ __('TIN') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="country" value="{{ old('country',$company->country) }}" type="text" placeholder="{{ __('Country') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="city" value="{{ old('city',$company->city) }}" type="text" placeholder="{{ __('City') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="address" value="{{ old('address',$company->address) }}" type="text" placeholder="{{ __('Address') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="phonenumber" value="{{ old('phonenumber',$company->phonenumber) }}" type="text" placeholder="{{ __('Phonenumber') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="email" value="{{ old('email',$company->email) }}" type="text" placeholder="{{ __('Email') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="website" value="{{ old('website',$company->website) }}" type="text" placeholder="{{ __('Website') }}">
                        </div>
                    </div>
