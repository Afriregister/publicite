...
<link rel="stylesheet" type="text/css" href="{{ asset('akarusho/src/plugins/datatables/css/dataTables.bootstrap4.min.css') }}"/>
<link rel="stylesheet" type="text/css" href="{{ asset('akarusho/src/plugins/datatables/css/responsive.bootstrap4.min.css') }}"/>
@endsection
								...
								<ul>
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{asset('admin/vendors/images/photo1.jpg')}}"
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{asset('admin/vendors/images/photo2.jpg')}}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{asset('admin/vendors/images/photo3.jpg')}}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
									...
									<li class="d-flex align-items-center justify-content-between">
										<div class="name-avatar d-flex align-items-center pr-2">
											<div class="avatar mr-2 flex-shrink-0">
												<img
													src="{{asset('admin/vendors/images/photo4.jpg')}}"
													class="border-radius-100 box-shadow"
													width="50"
													height="50"
													alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{asset('admin/vendors/images/photo5.jpg')}}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{asset('admin/vendors/images/photo6.jpg')}}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{asset('admin/vendors/images/photo9.jpg')}}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
							...
							<tr>
								<td class="table-plus">
									<div class="name-avatar d-flex align-items-center">
										<div class="avatar mr-2 flex-shrink-0">
											<img
												src="{{asset('admin/vendors/images/photo8.jpg')}}"
												class="border-radius-100 shadow"
												width="40"
												height="40"
												alt=""
