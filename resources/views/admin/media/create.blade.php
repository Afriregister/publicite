    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="{{ route('admin.media.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="short_name" value="{{ old('short_name') }}" type="text" placeholder="{{ __('Short name') }}">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">{{ __('Logo') }}</label>
                        <div class="col-sm-12 col-md-10">
