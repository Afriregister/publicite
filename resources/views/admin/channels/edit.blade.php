            ...
            <div class="pd-20 card-box mb-30">
                ...
                @endif
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select class="custom-select2 form-control" name="media_id">
                                ...
                                @foreach ($medias as $media)
                                    @if ($media->id == old('media_id',$channel->media_id))
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select class="custom-select2 form-control" name="platform_id">
                                ...
                                @foreach ($platforms as $platform)
                                    @if ($platform->id == old('platform_id',$channel->platform_id))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="name" value="{{ old('name',$channel->name) }}" type="text" placeholder="{{ __('Name') }}">
                        </div>
                    </div> 
            ...
            <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select name="status" class="custom-select col-12">
                                @if(old('status',$channel->status) == 1)
                                <option value="1" selected="selected">{{ __('Active') }}</option>
                                @else
                                <option value="1">{{ __('Active') }}</option>
                                @endif
                                @if(old('status',$channel->status) == 0)
