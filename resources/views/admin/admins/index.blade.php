            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        ...
                        -->
                        <a class="btn btn-primary" href="{{ route('admin.admins.create') }}">{{ __('Add') }} {{ __('Admin') }}</a>
                    </div>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="admins/{{$admin->id}}/edit"><i class="dw dw-edit2"></i> {{ __('Edit') }}</a>
                                            <a class="dropdown-item" href="admins/{{$admin->id}}/updatepassword"><i class="dw dw-password"></i> {{ __("Update Password") }} </a>

                                            <form action="{{ route('admin.admins.destroy',$admin->id) }}" method="POST" onSubmit="return confirm('{{__('Do you really want to delete?')}}')" class="dropdown-item">
                                            @method('DELETE')
                                            @csrf
