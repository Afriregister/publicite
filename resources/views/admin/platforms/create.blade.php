                        ...
                        <div class="col-sm-12 col-md-10">
                            @foreach ($formats as $format)
                                ...
                                <div class="custom-control custom-checkbox mb-5">
									<input type="checkbox" value="{{$format->id}}" class="custom-control-input" name="formats[]" id="format-{{$format->id}}"/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            @foreach ($cycles as $cycle)
                               ...
                               <div class="custom-control custom-checkbox mb-5">
									<input type="checkbox" value="{{$cycle->id}}" class="custom-control-input" name="cycles[]" id="cycle-{{$cycle->id}}"/>
