            ...
            <div class="pd-20 card-box mb-30">
                ...
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="firstname" value="{{ old('firstname') }}" type="text" placeholder="{{ __('Firstame') }}">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">{{ __('Lastname') }}</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="lastname" value="{{ old('lastname') }}" type="text" placeholder="{{ __('Lastname') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <select name="role" class="custom-select2 form-control">
                                <option value="client" @if(old('role') == 'client') selected="selected" @endif>Client</option>
                                <option value="company" @if(old('role') == 'company') selected="selected" @endif>Company</option>
                                <option value="sales" @if(old('role') == 'sales') selected="selected" @endif>Sales</option>
                                <option value="media" @if(old('role') == 'media') selected="selected" @endif>Technical/Media</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">{{ __('Confirm Password') }}</label>
                        <div class="col-sm-12 col-md-10">
