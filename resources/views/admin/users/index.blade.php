            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        ...
                        -->
                        <a class="btn btn-primary" href="{{ route('admin.users.create') }}">{{ __('Add') }} {{ __('User') }}</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if ($user->parent_id != null)
                                    #{{$user->parent_id}} {{$user->parent->firstname}} {{$user->parent->lastname}}
                                @else
                                    -
                                @endif
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="users/{{$user->id}}/edit"><i class="dw dw-edit2"></i> {{ __('Edit') }}</a>
                                            <a class="dropdown-item" href="users/{{$user->id}}/updatepassword"><i class="dw dw-password"></i> {{ __("Update Password") }} </a>

                                            <form action="{{ route('admin.users.destroy',$user->id) }}" method="POST" onSubmit="return confirm('{{__('Do you really want to delete?')}}')" class="dropdown-item">
                                            @method('DELETE')
                                            @csrf
